...
<head>
	...
	<?php
		...
		$sql = "select * from clients where print = 5686 limit 5"; //还要限制是当天的
	...
	<SCRIPT language=javascript>
		...
		function doPrintAgain(str)
		{
			...
			xmlhttp.open("GET","../controller/printagain.php?q="+str,true);
			xmlhttp.send();
		}
	</SCRIPT>
...
">
  ...
  height:26.4pt'> <?php echo $pdata['mydata1']['product'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata1']['nums']==0?"":$pdata['mydata1']['nums']  ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata1']['unit'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata1']['price']==0?"":$pdata['mydata1']['price'] ?> </td>
				<td class=xl6626514> 空 </td>
  ...
  height:26.4pt'><?php echo $pdata['mydata2']['product'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata2']['nums']==0?"":$pdata['mydata2']['nums']  ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata2']['unit'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata2']['price']==0?"":$pdata['mydata2']['price'] ?> </td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
  ...
  height:26.4pt'><?php echo $pdata['mydata3']['product'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata3']['nums']==0?"":$pdata['mydata3']['nums']  ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata3']['unit'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata3']['price']==0?"":$pdata['mydata3']['price']  ?> </td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
  ...
  height:26.4pt'><?php echo $pdata['mydata4']['product'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata4']['nums']==0?"":$pdata['mydata4']['nums']  ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata4']['unit'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata4']['price']==0?"":$pdata['mydata4']['price']  ?> </td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
  ...
  height:26.4pt'><?php echo $pdata['mydata5']['product'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata5']['nums']==0?"":$pdata['mydata5']['nums']  ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata5']['unit'] ?> </td>
				<td class=xl6626514><?php echo $pdata['mydata5']['price']==0?"":$pdata['mydata5']['price']  ?> </td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
				<td class=xl6626514>　</td>
		...
		<INPUT type=button value=重新开票 name=button_again onclick=javascript:doPrintAgain() />&nbsp&nbsp&nbsp
