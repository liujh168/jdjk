    ...
    <div id="main">
        <nav>
            ...
            <ul>
                ...
                <li><a href="action.php?flag=print" target="_blank">打印单据</a></li>
        ...
        <section class="post">
            <article>
                <form action="saveclient.php" method="post" name="addForm" onsubmit="return CheckPost();">
                    <div class="title">
                    ...
                    <div class="main">
                        ...
                        <div class="content clearfix">
                            ...
                            <div>
                                名称： <input id= id_username type="text" name="username" placeholder="客户名称" /><br />
                            </div>
                            <div>
                        ...
                        <div class="content clearfix">
                            ...
                            <div>
                                名称： <input type="text" name="product" placeholder="商品名称" /><br />
                            </div>
                            <div>
                                单位： <select name="unit">
                            ...
                            <div>
                                <textarea name="memo" rows="4" cols="25" placeholder="备注"></textarea><br />
                            </div>
                            <div>
